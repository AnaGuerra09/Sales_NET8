    ...
    public class CountriesController : Controller
    {
        ...
        public async Task<IActionResult> Create(Country country)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError("Name", "Este país já existe! Insira outro diferente.");
                    return View(country);
                }
                ...
                try
                {
                    ...
                    TempData["SuccessMessage"] = "País criado com sucesso!";
                    return RedirectToAction(nameof(Index));
                }
                catch (DbUpdateException)
                {
                    ModelState.AddModelError("", "Ocorreu um erro ao criar o país!");
